...
// - створити блок,
//     - додати йому класи wrap, collapse, alpha, beta, beta
...
// htmlDivElement.style.width = '150px';
...
//     {title: 'Інтерфейс', monthDuration: 4}
// ];
//
...
//     htmlParagraphElement1.innerText = `${item.monthDuration}`;
//     DivElement.append(htmlParagraphElement1, htmlHeadingElement);
...
//
//     divElement.append(h2Elem, divEl, htmlParagraphElement, parag);
